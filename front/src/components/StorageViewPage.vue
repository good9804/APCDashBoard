        ...
        <div class="inline-flex flex-col">
          <div class="flex gap-4 mb-4">
            <iframe
              ...
              width="1100"
              height="605"
              src="https://09c0-118-36-223-138.ngrok-free.app/webgl2/"
              frameborder="0"
              framespacing="0"
              marginheight="0"
              marginwidth="0"
          ...
          <div>
            ...
            >
              <div class="flex items-center px-3 py-2">
                <select
                  id="Zone"
                  v-model="storage_info.zone_number"
                ...
                <div class="inline-flex items-center px-3 py-2">
                  <button
                    @click="selectStorage(storage_info.zone_number)"
              ...
              <h5
                class="mb-2 text-4xl font-semibold text-center tracking-tight text-gray-500 dark:text-gray"
              >
                Zone {{ select_storage_info.zone_number }}
              </h5>
              <h2
                class="mb-2 text-8xl font-bold text-center tracking-tight text-black-900 dark:text-black"
              >
                {{
              ...
              <h5
                class="mb-2 text-2xl font-semibold text-center tracking-tight text-gray-900 dark:text-gray"
              >
                최근 입고 :
                {{
                  all_storage_info[select_storage_info.zone_number - 1]
